<%@ Page Title="" Language="C#" MasterPageFile="~/EDMS_AdminMaster.master" AutoEventWireup="true" CodeFile="Add_Project.aspx.cs" Inherits="ADMIN_Add_Project" %>
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    ...
                    <asp:Table ID="tblHeader" runat="server" Width="100%" CssClass="table-responsive-lg">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell VerticalAlign="Top">
                                <p class="text-left">
                                    <asp:Label ID="Label7" runat="server" Text="* " CssClass="font-weight-bold" ForeColor="Red" />
                            ...
                            <asp:TableCell>
                                <div class="form-group row">
                                    <asp:TextBox ID="fldPCode" runat="server" CssClass="form-control form-control-sm" Width="215"></asp:TextBox>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell VerticalAlign="Top">
                                <p class="text-left">
                                    <asp:Label ID="Label8" runat="server" Text="* " CssClass="font-weight-bold" ForeColor="Red" />
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell VerticalAlign="Top">
                                <p class="text-left">
                                    <asp:Label ID="Label9" runat="server" Text="* " CssClass="font-weight-bold" ForeColor="Red" />
                    ...
                    <div class="col-sm-12 text-center">
                        <asp:Button ID="btnAdd" runat="server" Text="Add" class="btn btn-success btn-md center-block font-weight-bold" Width="100" OnClick="btnSave_Click"></asp:Button>
                    ...
                    <asp:Table ID="tblInNote" runat="server" Width="100%" CssClass="input-sm">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell ColumnSpan="3" ForeColor="Gray">
                                <p class=" text-left small">
                                    <asp:Label ID="lbl5" runat="server" Text="* " CssClass="small font-weight-bold" ForeColor="Red"></asp:Label>
                                    <asp:Label ID="lbl9" runat="server" Text="is mandatory fields " CssClass="small"></asp:Label>
                                </p>
                                <p class=" text-left small">
                                    <asp:Label ID="Label2" runat="server" Text="Click on the " CssClass="small"></asp:Label>
                                    <asp:Label ID="Label3" runat="server" Text="Save " CssClass="small font-weight-bold"></asp:Label>
                                    <asp:Label ID="Label4" runat="server" Text="button to add new record." CssClass="small"></asp:Label>
                                </p>
                                <p class=" text-left small">
                                    <asp:Label ID="Label1" runat="server" Text="Click on the " CssClass="small"></asp:Label>
                                    <asp:Label ID="Label5" runat="server" Text="Reset " CssClass="small font-weight-bold"></asp:Label>
                                    <asp:Label ID="Label6" runat="server" Text="button to clear the data." CssClass="small"></asp:Label>
                                </p>
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
            ...
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text-center">All mandatory fields must be filled!</p>
                        <p class="text-center">Please check again.</p>
                    </div>
        ...
        <div id="SuccessModal" class="modal fade">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text-center">New project has been successfully created.</p>
                    </div>
                    <div class="modal-footer">
