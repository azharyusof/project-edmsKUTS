<%@ Page Title="" Language="C#" MasterPageFile="~/EDMS_Masterpage.master" AutoEventWireup="true" CodeFile="Out_Upload_Document.aspx.cs" Inherits="SITE_Outgoing_Out_Upload_Document" %>
                            ...
                            <asp:TableCell VerticalAlign="Top">
                                <div class="form-group row">
                                    <div class=" custom-file">
                                        <asp:FileUpload ID="FileUpload1" class="multi form-control form-control-sm custom-file-input" runat="server" />
