<%@ Page Title="" Language="C#" MasterPageFile="~/EDMS_Masterpage.master" AutoEventWireup="true" CodeFile="Package.aspx.cs" Inherits="SITE_Administrator_Package" %>
    ...
    <form class="validate-form" runat="server">
        <div class="project-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            <hgroup>
                ...
                <h3 class="font-weight-bold text-muted">PACKAGE</h3>
            </hgroup>
        </div>
        ...
        <div class="container card-deck mb-3 text-center">
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    ...
                    <asp:GridView ID="GridPackage" runat="server" Width="100%" AutoGenerateColumns="false" AllowPaging="true" ShowFooter="true"
                        OnPageIndexChanging="OnPaging" OnRowEditing="EditPackage" OnRowUpdating="UpdatePackage" OnRowCancelingEdit="CancelEdit"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ItemStyle-Width="400px" HeaderText="Package" ItemStyle-VerticalAlign="Top" HeaderStyle-Font-Size="Smaller" ControlStyle-Font-Size="Smaller">
                                <ItemTemplate>
                                    <asp:Label ID="lblPackage" runat="server"
                                        Text='<%# Eval("FLD_PACKAGE")%>' CssClass="input-sm"></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtPackage" runat="server"
                                        Text='<%# Eval("FLD_PACKAGE")%>' Width="800" CssClass="form-control input-sm"></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtPackage" runat="server" CssClass="form-control input-sm border-primary" Width="800"></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField ItemStyle-Width="20px" ItemStyle-VerticalAlign="Top" HeaderStyle-Font-Size="Smaller" ControlStyle-Font-Size="Smaller">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkRemove" runat="server" CommandArgument='<%# Eval("ID")%>' OnClientClick="return confirm('Are you sure you want to delete this record?')" Text="Delete" OnClick="DeletePackage"></asp:LinkButton>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:Button ID="btnAdd" runat="server" Text="Add" OnClick="AddNewPackage" CssClass="btn btn-sm text-muted" />
                                </FooterTemplate>
                            </asp:TemplateField>
