<%@ Page Title="" Language="C#" MasterPageFile="~/EDMS_Masterpage.master" AutoEventWireup="true" CodeFile="TypeDocument.aspx.cs" Inherits="SITE_Administrator_TypeDocument" %>
    ...
    <form class="validate-form" runat="server">
        <div class="project-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            <hgroup>
                ...
                <h3 class="font-weight-bold text-muted">TYPE OF DOCUMENT</h3>
            </hgroup>
        </div>
        ...
        <div class="container card-deck mb-3 text-center">
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    ...
                    <asp:GridView ID="GridTypeDoc" runat="server" Width="100%" AutoGenerateColumns="false" AllowPaging="true" ShowFooter="true"
                        OnPageIndexChanging="OnPaging" OnRowEditing="EditType" OnRowUpdating="UpdateType" OnRowCancelingEdit="CancelEdit"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ItemStyle-Width="400px" HeaderText="Type of Document" HeaderStyle-CssClass="text-sm-center" ItemStyle-VerticalAlign="Top" HeaderStyle-Font-Size="Smaller" ControlStyle-Font-Size="Smaller">
                                <ItemTemplate>
                                    <asp:Label ID="lbType" runat="server"
                                        Text='<%# Eval("FLD_TYPE")%>' CssClass="input-sm"></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtType" runat="server"
                                        Text='<%# Eval("FLD_TYPE")%>' Width="800" CssClass="form-control input-sm border-primary"></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtType" runat="server" CssClass="form-control input-sm border-primary" Width="800"></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField ItemStyle-Width="20px" ItemStyle-VerticalAlign="Top" HeaderStyle-Font-Size="Smaller" ControlStyle-Font-Size="Smaller">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkRemove" runat="server" CommandArgument='<%# Eval("ID")%>' OnClientClick="return confirm('Are you sure you want to delete this record?')" Text="Delete" OnClick="DeleteType"></asp:LinkButton>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:Button ID="btnAdd" runat="server" Text="Add" OnClick="AddNewType" CssClass="btn btn-default btn-sm" />
                                </FooterTemplate>
                            </asp:TemplateField>
