<%@ Page Title="" Language="C#" MasterPageFile="~/EDMS_Masterpage.master" AutoEventWireup="true" CodeFile="FileIndex.aspx.cs" Inherits="SITE_Administrator_FileIndex" %>
    ...
    <form class="validate-form" runat="server">
        <div class="project-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            <hgroup>
                ...
                <h3 class="font-weight-bold text-muted">FILE INDEX</h3>
            </hgroup>
        </div>
        ...
        <div class="container card-deck mb-3 text-center">
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="false" AllowPaging="true" ShowFooter="true"
                        OnPageIndexChanging="OnPaging" OnRowEditing="EditIndex" OnRowUpdating="UpdateIndex" OnRowCancelingEdit="CancelEdit"
                        ShowHeaderWhenEmpty="false" EmptyDataText="There are no data records to display."
                        PageSize="50" CssClass="table table-bordered table-striped input-sm">
                        <Columns>
                            ...
                            <asp:TemplateField ItemStyle-Width="400px" HeaderText="File Index" ItemStyle-VerticalAlign="Top" HeaderStyle-Font-Size="Smaller" ControlStyle-Font-Size="Smaller">
                                <ItemTemplate>
                                    <asp:Label ID="lbIndex" runat="server"
                                        Text='<%# Eval("FLD_INDEX")%>' CssClass="input-sm"></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtIndex" runat="server"
                                        Text='<%# Eval("FLD_INDEX")%>' CssClass="form-control input-sm border-primary" Width="800"></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtIndex" runat="server" CssClass="form-control input-sm border-primary" Width="800"></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField ItemStyle-Width="20px" ItemStyle-VerticalAlign="Top" HeaderStyle-Font-Size="Smaller" ControlStyle-Font-Size="Smaller">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkRemove" runat="server" CommandArgument='<%# Eval("ID")%>' OnClientClick="return confirm('Are you sure you want to delete this record?')" Text="Delete" OnClick="DeleteIndex"></asp:LinkButton>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:Button ID="btnAdd" runat="server" Text="Add" OnClick="AddNewIndex" CssClass="btn btn-default btn-sm" />
                                </FooterTemplate>
                            </asp:TemplateField>
